...
function Main600() {
  return (
    <div className="flex column align-center overflow-hidden">
      ...
      <div className='sm-section md-section-4'>
      ...
      <div className="sm-section section-6" >
          ...
          <Stack className="sm-section-6-faq" spacing="30px">
            <Accordion className="sm-section-6-faq-a">
              ...
              >
                <p className="f-b20b"> 안쓰면 정말 환불해 주나요? </p>
              </AccordionSummary>
              <AccordionDetails >
                <p className="f-b15 c-f-c666">물론입니다. 결제 후 콘텐츠 다운로드 및 열람을 하지 않으셨다면 전액 환불해 드리고 있어요.</p>
                <p className="f-b15 c-f-c666"> <span className='f-b14b'>[초이 &gt; 관리 &gt; 구독관리 &gt; 결제 내역 확인]</span>에서 직접 환불이 가능하며,</p>
                <p className="f-b15 c-f-c666">해결이 어려운 경우 고객센터로 문의해 주세요.</p>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className="sm-section-6-faq-a">
              <AccordionSummary 
                expandIcon={<ExpandMore fontSize='100px' className="sm-section-6-faq-icon"/>}
              >
                <p className="f-b20b"> 구독 중 해지 할 수 있나요? 수수료는 없나요? </p>
              </AccordionSummary>
              <AccordionDetails >
                <p className="f-b15 c-f-c666">다음달부터 결제되지 않도록 수수료 없이 언제든지 해지하실 수 있습니다.</p>
                <p className="f-b15 c-f-c666"> <span className='f-b14b'>[초이 &gt; 관리 &gt; 구독관리 &gt; 자동결제 해지]</span> 메뉴를 통해 기간에 상관없이 직접 가능해요.</p>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className="sm-section-6-faq-a">
              <AccordionSummary 
                expandIcon={<ExpandMore fontSize='100px' className="sm-section-6-faq-icon"/>}
              >
                <p className="f-b20b"> 무료 혜택은 누구나 받을 수 있나요? </p>
              </AccordionSummary>
              <AccordionDetails >
                <p className="f-b15 c-f-c666">네, 초이 회원이라면 누구나 첫 정기구독 신청 시 1회 제공됩니다.</p>
                <p className="f-b15 c-f-c666"> <span className='f-b14b'>[초이 &gt; 관리 &gt; 구독관리 &gt; 결제 내역 확인]</span>에서 직접 환불이 가능하며,</p>
                <p className="f-b15 c-f-c666">해결이 어려운 경우 고객센터로 문의해 주세요.</p>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className="sm-section-6-faq-a">
              <AccordionSummary 
                expandIcon={<ExpandMore fontSize='100px' className="sm-section-6-faq-icon"/>}
              >
                <p className="f-b20b"> 어떤 기기에서 사용할 수 있나요? </p>
              </AccordionSummary>
              <AccordionDetails >
